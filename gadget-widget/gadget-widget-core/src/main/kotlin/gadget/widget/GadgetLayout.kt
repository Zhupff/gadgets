...
open class GadgetLayout @JvmOverloads constructor(
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        if (measuredWidth > 0 && measuredHeight > 0) {
            ...
            super.onMeasure(
                MeasureSpec.makeMeasureSpec((measuredWidth - realBorderWidth * 2).coerceAtLeast(0), MeasureSpec.getMode(widthMeasureSpec)),
                MeasureSpec.makeMeasureSpec((measuredHeight - realBorderWidth * 2).coerceAtLeast(0), MeasureSpec.getMode(heightMeasureSpec)))
