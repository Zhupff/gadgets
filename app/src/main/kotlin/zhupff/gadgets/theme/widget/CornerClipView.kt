...
class CornerClipView @JvmOverloads constructor(
    ...
    init {
        context.obtainStyledAttributes(attrs, R.styleable.CornerClipView)
            .also { typedArray ->
                cornerRadius = typedArray.getDimension(R.styleable.CornerClipView_CornerClipRadius, cornerRadius)
                borderWidth = typedArray.getDimension(R.styleable.CornerClipView_BorderWidth, borderWidth)
                borderColor = typedArray.getColor(R.styleable.CornerClipView_BorderColor, borderColor)
            }
            .recycle()
