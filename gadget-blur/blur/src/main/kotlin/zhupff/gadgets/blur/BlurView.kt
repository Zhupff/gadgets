...
import zhupff.gadgets.blur.BlurLayout.Companion.BLUR_DRAW_STRATEGY_ALL_FRAMES
import zhupff.gadgets.blur.BlurLayout.Companion.BLUR_DRAW_STRATEGY_IGNORE_IDENTICAL_FRAMES
...
class BlurView @JvmOverloads constructor(
    ...
    init {
        context.obtainStyledAttributes(attrs, R.styleable.BlurView).also { typedArray ->
            blurRadius = typedArray.getInt(R.styleable.BlurView_blurRadius, blurRadius)
