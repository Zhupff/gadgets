...
open class BlurLayout @JvmOverloads constructor(
    ...
    init {
        context.obtainStyledAttributes(attrs, R.styleable.BlurLayout).also { typedArray ->
            blurScale = typedArray.getFloat(R.styleable.BlurLayout_blurScale, DEFAULT_BLUR_SCALE)
            blurCanvasStrategy = typedArray.getInt(R.styleable.BlurLayout_blurCanvas, BLUR_CANVAS_STRATEGY_INHERITED)
        }.recycle()
    }
