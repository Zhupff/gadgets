...
import com.google.mcu.dynamiccolor.ColorSpec.SpecVersion;
...
public final class DynamicColor {
  ...
  public static class Builder {
    ...
    public Builder setPalette(Function<DynamicScheme, TonalPalette> palette) {
      this.palette = palette;
      return this;
    }

    public Builder setTone(Function<DynamicScheme, Double> tone) {
      this.tone = tone;
      return this;
    }
    ...
    public Builder setChromaMultiplier(Function<DynamicScheme, Double> chromaMultiplier) {
      this.chromaMultiplier = chromaMultiplier;
      return this;
    }

    public Builder setBackground(Function<DynamicScheme, DynamicColor> background) {
      this.background = background;
      return this;
    }
    ...
    public Builder setContrastCurve(Function<DynamicScheme, ContrastCurve> contrastCurve) {
      this.contrastCurve = contrastCurve;
      return this;
    }

    public Builder setToneDeltaPair(Function<DynamicScheme, ToneDeltaPair> toneDeltaPair) {
      this.toneDeltaPair = toneDeltaPair;
      return this;
    }

    public Builder setOpacity(Function<DynamicScheme, Double> opacity) {
      this.opacity = opacity;
      return this;
    }
