...
public final class QRCodeMultiReader extends QRCodeReader {
  ...
  public Result[] decodeMultiple(BinaryBitmap image) throws NotFoundException {
    ...
    DetectorResult[] detectorResults = new MultiDetector(image.getBlackMatrix()).detectMulti();
  ...
  static List<Result> processStructuredAppend(List<Result> results) {
    ...
    Result newResult = new Result(newText.toString(), newRawBytes.toByteArray(), NO_POINTS);
